  ...
  return (
    <section className="py-24 bg-black border-t border-white/5">
      <div className="container mx-auto px-6">
        <div className="bg-gradient-to-br from-blue-900/20 to-purple-900/20 border border-white/10 rounded-3xl p-12 text-center relative overflow-hidden">
            ...
            <div className="relative z-10 max-w-2xl mx-auto">
                <h2 className="text-3xl lg:text-4xl font-bold text-white mb-6">Find the Right Package for Your Project</h2>
                <p className="text-xl text-gray-400 mb-8">
                    Every construction project is unique. Talk to us to identify the right platform package and service mix for your needs.
                </p>
